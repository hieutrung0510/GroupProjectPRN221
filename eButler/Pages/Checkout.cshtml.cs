...
namespace eButler.Pages
{
    ...
    public class CheckoutModel : PageModel
    {
        ...
        {
            data = new StringContent("{\"intent\": \"AUTHORIZE\",\"purchase_units\": [{\"amount\": {\"currency_code\": \"USD\",\"value\": \""+ amount +"\"}}],\"application_context\": {\"brand_name\": \"eButler\",\"shipping_preference\": \"NO_SHIPPING\",\"return_url\": \"https://localhost:44331/checkoutsuccess?status=COMPLETED\"}}", Encoding.UTF8, "application/json");
